...
<div class="card">
    <div class="card-body">
        <form method="POST" action="<?php echo e(route('admin.patients.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control <?php $__errorArgs = ['blood_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                           id="blood_group" name="blood_group" value="<?php echo e(old('blood_group')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                           id="height" name="height" value="<?php echo e(old('height')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                          id="allergies" name="allergies" rows="2"><?php echo e(old('allergies')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex justify-content-end">
                <a href="<?php echo e(route('admin.patients.index')); ?>" class="btn btn-secondary me-2">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nirmalgoswami/Documents/clg-projects/Hospital-management/resources/views/admin/patients/create.blade.php ENDPATH**/ ?>