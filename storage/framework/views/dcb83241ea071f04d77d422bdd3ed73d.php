<?php $__env->startSection('title', 'Receptionist Dashboard'); ?>
...
<div class="page-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Welcome, <?php echo e(auth()->user()->name); ?>! Manage front desk operations efficiently.</p>
        </div>
        <div>
    ...
    <div class="col-md-4 mb-4">
        <div class="card h-100" style="border-left: 5px solid #667eea;">
            <div class="card-body text-center">
                ...
                <a href="<?php echo e(route('admin.patients.create')); ?>" class="btn btn-primary w-100 mb-3" style="padding: 1rem;">
                    <i class="bi bi-person-plus"></i> Register Patient
                </a>
                <a href="<?php echo e(route('appointments.create')); ?>" class="btn btn-success w-100 mb-3" style="padding: 1rem;">
                    <i class="bi bi-calendar-plus"></i> Book Appointment
                </a>
                <a href="<?php echo e(route('billing.create')); ?>" class="btn btn-info w-100" style="padding: 1rem;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nirmalgoswami/Documents/clg-projects/Hospital-management/resources/views/receptionist/dashboard.blade.php ENDPATH**/ ?>